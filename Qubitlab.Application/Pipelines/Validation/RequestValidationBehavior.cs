...
using ValidationException = Qubitlab.CrossCuttingConcerns.Exceptions.ExceptionTypes.ValidationException;

namespace Qubitlab.Application.Pipelines.Validation;
